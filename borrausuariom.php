...
<html lang="es">
    ...
    <li><a href="borrarusuariom.php">Eliminar Usuario</a></li>
	...
	<li><a href="cerrarsesion.php">Cerrar Sesión</a></li>
		...
		<div class="container">
			...
			<form action="borrarusuario.php" method="POST">
				...
				<label class="control-label col-sm-2" for="email">id_usr:</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="user_new" name="id_usr" placeholder="Ingresa el id_usr">
				</div>
			</div>
