...
$checkuser=mysqli_query($miConexion,"SELECT * FROM productos WHERE id_p='$id_p'");
$check_user=mysqli_num_rows($checkuser);
if($check_user=0){
	echo '<script language="javascript">alert("No existe el producto indicado"); </script>';
}else{
	$consulta ="DELETE FROM `productos` WHERE id_p=$id_p";
...
<body>
  ...
  <strong>Correcto!</strong> Se borró el producto de la base de datos.
</div>
<div class="col-xs-4">
				<a href="gerente.php" class="btn btn-success" role="button">Inicio</a>
			</div>
