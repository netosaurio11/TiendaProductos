<?php
require('conex.php');
if (!isset($_POST['usuario']) || !isset($_POST['nombre']) || !isset($_POST['contra']) || !isset($_POST['ap_mat']) || !isset($_POST['ap_pat']) || !isset($_POST['edad']) || !isset($_POST['tipo'])) {
	# code...
?>
<!DOCTYPE html>
<html lang="es">
...
<html lang="es">
	...
	<body>
		<div class="alert alert-success">
			<strong>Correcto!</strong> Se añadió en la base de datos.
		</div>
		<div class="col-xs-4">
			<a href="gerente.php" class="btn btn-success" role="button">Inicio</a>
		</div>
