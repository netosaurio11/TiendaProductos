...
<div class="container">
		...
		<h2>Añadir Producto</h2>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="user_new" name="nombre" placeholder="Ingresa nombre del producto">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="pwd">Precio</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="pwd" name="precio" placeholder="Ingresa precio del producto">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="email">Descripcion:</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="name_new" name="descripcion" placeholder="Ingresa una breve descripcion">
				</div>
			</div>
